...
export function SidebarTools({ action, children, query, onQuery, label }: {
  ...
  return <>
    <div className="sidebar-actions">
      ...
      <Button variant="ghost" size="icon-sm" ref={trigger} className="sidebar-search-toggle" aria-label={label} title={label}
    ...
    {expanded && <div className="sidebar-search" id={id}>
      ...
      <Button variant="ghost" size="icon-sm" aria-label="Close search" title="Clear and close search" onClick={close}>×</Button>
    </div>}
  </>
}
