...
| [terminal-input.md](terminal-input.md) | `INPUT` | 31 | what the user types into: the box, the keys, and where a terminal's own limits show through |
...
| [backends.md](backends.md) | `BACKEND` | 31 | which service answers a request, and what a person may choose between |
